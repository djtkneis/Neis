namespace Neis.FileCleanup.Service
{
    partial class ProjectInstaller
    {
        ...
        private void InitializeComponent()
        {
            ...
            // _serviceInstaller
            // 
            this._serviceInstaller.Description = "Cleans old files from the system";
            this._serviceInstaller.DisplayName = "File Cleanup Sevice";
            this._serviceInstaller.ServiceName = "Neis.FileCleanup.Service";
